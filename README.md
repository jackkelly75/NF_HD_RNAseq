...
sudo ./nextflow run jackkelly75/NF_HD_RNAseq --reads 'media/mynewdrive/NextFlow/data/*_{1,2}.fastq.gz' --transcriptome 'media/mynewdrive/NextFlow/data/hsapien.fa.gz'
```
